...
var AuthService = (function () {
    function AuthService(httpClient, storage, router) {
    ...
    AuthService.prototype.login = function (userLogin) {
        ...
        return this.httpClient.post(this.endpointURL, body)
            ...
            if (res.data.credentials.token) {
                ...
                _this.storage.setEncryptedItem('token', res.data.credentials.token);
                console.log(_this.storage.getDecryptedItem('token'));
            }
...
AuthService = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [HttpClient, SessionStorageService, Router])
], AuthService);
export { AuthService };
