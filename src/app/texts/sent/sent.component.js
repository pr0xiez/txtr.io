...
var SentComponent = (function () {
    function SentComponent(httpClient, authService) {
        this.httpClient = httpClient;
        this.authService = authService;
        this.displayedColumns = ['id', 'messageId', 'to', 'portalCode', 'scheduledDate'];
        this.messages = new SentMessagesDataSource(this.httpClient, this.authService);
    }
